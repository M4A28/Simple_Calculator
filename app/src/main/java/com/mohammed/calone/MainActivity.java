...
public class MainActivity extends AppCompatActivity {
    ...
    public static final int NOTE_ID = 7;
    @Override
        ...
        if (!display.getText().toString().isEmpty()) {
            try {
                ...
                if (answer.isInfinite()) {
                    ...
                    if(display.getText().toString().length() > 60){
                        Toast.makeText(this,
                                R.string.max_len,
                                Toast.LENGTH_LONG)
                                .show();
    ...
    private void getPremission() {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            ActivityCompat.requestPermissions(this, per, 4);
        }
    }
    ...
    private void simpleNotification() {
        ...
        builder.setContentIntent(notificationIntent)
                ...
                .setContentText("Happy weekend and have a nice day my friend")
                .setTicker("weekend")
                .setContentTitle("CHICK OUT!!")
